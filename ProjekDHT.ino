...
// Harus diisi
#define FIREBASE_HOST "https://monitoring-sensor-dht---340-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "tIOqB1dU12hiJv1buUOj5Eb1ibuSFM5DLXNGfHGw"
#define WIFI_SSID "Poiuu"
...
void loop(){
  ...
  if (Firebase.setString(firebaseData, "/Sensor-DHT/hari", daysOfTheWeek[timeClient.getDay()])){
  ...
  if (Firebase.setString(firebaseData, "/Sensor-DHT/jam", timeClient.getHours())){
  ...
  if (Firebase.setString(firebaseData, "/Sensor-DHT/menit", timeClient.getMinutes())){
  ...
  if (Firebase.setString(firebaseData, "/Sensor-DHT/detik", timeClient.getSeconds())){
  ...
  if (Firebase.setFloat(firebaseData, "/Sensor-DHT/suhu", t)){
  ...
  if (Firebase.setFloat(firebaseData, "/Sensor-DHT/kelembaban", h)){
